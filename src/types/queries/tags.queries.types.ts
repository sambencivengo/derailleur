import { PostCursor, TagWithPostCount, TagWithPosts, TagWithPostsForViewer } from "~/types";
...
export type GetTagWithPostsByName = (tagId: string, userId?: string, cursor?: PostCursor) => Promise<DerailleurResponse<TagWithPostsForViewer>>;
