import { PostCursor, TagWithPostCount, TagWithPosts } from "~/types";
...
export type GetTagWithPostsByName = (tagId: string, userId?: string, cursor?: PostCursor) => Promise<DerailleurResponse<TagWithPosts>>;
